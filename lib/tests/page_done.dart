...
//                           backgroundCircularColor: Colors.blue,
//                         ));
//                       return new ListView(
...
//     List<Workorder> listElement = new List(), listElement2;
//     Map<String, List<Workorder>> userMap = new Map();
...
//             listElement.add(new Workorder());
//           }
//           if (b.runtimeType == String && a == "color") {
//             cardColor.add(b);
//           }
//         });
//         listElement2 = new List<Workorder>.from(listElement);
