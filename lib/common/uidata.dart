...
class StringConstant {
  static const String timesheetValidateMessage =
      "Your timesheet should have min of 10 characters";
  static const String nameValidateMessage = "Only alphabets are allowed";
  static const String emailField = "email";
  static const String timesheetField = "timesheets";
  ...
  static const String timesheetListTitle = "Goals List";
...
class UIData {
  ...
  //strings
  static const String appName = "Andrews App";
  ...
  static const String pkImage = "$imageDir/icon.png";
