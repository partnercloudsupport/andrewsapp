...
//         mapController
//             .fitBounds(new LatLngBounds(widget.topRight, widget.botLeft));
//       } else {
...
//                   mapController.move(
//                       new LatLng(location.latitude, location.longitude), 17.75);
//                   setState(() {
...
//         topRight = new LatLng(location.latitude,
...
//         botLeft = new LatLng(location.latitude,
...
//                   eventsAtLocation, markerSelectionController);
//             });
//       } else {
//         return new CustomMarker(
//             width: 500.0,
...
//                   eventsAtLocation.first, markerSelectionController);
//             });
//       }
//     }).toList();
...
//     DateTime todayEnd =
//         new DateTime(now.year, now.month, now.day, 23, 59, 59, 59);

//     return StreamBuilder(
//       stream: Firestore.instance
//           .collection('events')
//           .where('date_start',
//               isGreaterThanOrEqualTo: todayStart, isLessThanOrEqualTo: todayEnd)
//           .snapshots(),
...
//           Rect.fromLTWH(oldIndex * indicatorWidth, 0.0, indicatorWidth,
//               _kIndicatorHeight),
//           Rect.fromLTRB(0.0, 0.0, indicatorWidth * widget.items.length,
//               _kIndicatorHeight)),
//       end: new RelativeRect.fromRect(
//           Rect.fromLTWH(widget.currentIndex * indicatorWidth, 0.0,
//               indicatorWidth, _kIndicatorHeight),
//           Rect.fromLTRB(0.0, 0.0, indicatorWidth * widget.items.length,
//               _kIndicatorHeight)),
...
//                 shape: new RoundedRectangleBorder(
//                     borderRadius:
//                         BorderRadius.circular(_kIndicatorHeight / 2.0)),
//                 child: Padding(
...
//               begin:
//                   new RelativeRect.fromLTRB(0.0, -(fromTopAtStart), 0.0, 0.0),
//               end: new RelativeRect.fromLTRB(
//                   fromLeftAtEnd, 0.0, fromRightAtEnd, 0.0))
//           .animate(expandCurve));
//     }
...
//   AnimatedMarker(this.event, this.selectionController,
//       {this.tapDelegate, this.showDot = true});
...
//     animation = new ColorTween(begin: Colors.red, end: Colors.blue)
//         .animate(_controller);
...
//       {Key key, @required this.event, @required this.listenable})
//       : super(key: key);
...
//             minHeight: kMarkerIndicatorSize, minWidth: kMarkerIndicatorSize),
