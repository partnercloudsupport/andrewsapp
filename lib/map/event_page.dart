...
//                 onPressed: () {
//                   openMaps(
//                       context, widget.event['location'], widget.event['title']);
//                 },
//               ),
//             )
//           ],
...
//     String startString =
//         '${toTwelveHour(startDate.hour)}:${twoDigits(startDate.minute)} ${amOrPm(startDate.hour)}';
//     String endString =
//         '${toTwelveHour(endDate.hour)}:${twoDigits(endDate.minute)} ${amOrPm(endDate.hour)}';
...
//   EventCategoryCard(
//       {@required this.controller, @required this.heading, @required this.body});
...
//                           selectedTime: _toTimeOfDay(startDate) ??
//                               _toTimeOfDay(document['date_start']),
//                           selectDate: (date) {
//                             int hour =
//                                 startDate != null ? startDate.hour : date.hour;
//                             int minute = startDate != null
//                                 ? startDate.minute
//                                 : date.minute;
...
//                                 ? startDate.year
//                                 : document['date_start'].year;
//                             int month = startDate != null
//                                 ? startDate.month
//                                 : document['date_start'].month;
//                             int day = startDate != null
//                                 ? startDate.day
//                                 : document['date_start'].day;
...
//                           selectedTime: _toTimeOfDay(endDate) ??
//                               _toTimeOfDay(document['date_end']),
//                           selectDate: (date) {
//                             int hour =
//                                 endDate != null ? endDate.hour : date.hour;
//                             int minute =
//                                 endDate != null ? endDate.minute : date.minute;
...
//                           },
//                           selectTime: (timeOfDay) {
//                             int year = endDate != null
//                                 ? endDate.year
//                                 : document['date_end'].year;
//                             int month = endDate != null
//                                 ? endDate.month
//                                 : document['date_end'].month;
//                             int day = endDate != null
//                                 ? endDate.day
//                                 : document['date_end'].day;
