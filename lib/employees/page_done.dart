...
class _DonePageState extends State<DonePage>
  ...
  getExpenseItems(AsyncSnapshot<QuerySnapshot> snapshot) {
    List<JobModel> listElement = new List(), listElement2;
    Map<String, List<JobModel>> userMap = new Map();
      ...
      snapshot.data.documents.map<List>((f) {
        f.data.forEach((a, b) {
          if (b.runtimeType == bool) {
            listElement.add(new JobModel());
          }
          if (b.runtimeType == String && a == "color") {
            cardColor.add(b);
          }
        });
        listElement2 = new List<JobModel>.from(listElement);
