...
Widget _buildEmployeeListTile(BuildContext context, employee, device) {
  return new ListTile(
    onTap: () => _navigateToEmployeeDetails(context, employee, device),
    leading: new Hero(
      // tag: index,
...
void _navigateToEmployeeDetails(context, Employee employee, Device device) {
  Navigator.of(context).push(
    new MaterialPageRoute(
      builder: (c) {
        return new EmployeeDetailsPage(employee: employee);
      },
    ),
  );
}
  ...
  Widget build(BuildContext context) {
    return new Container(
        ...
        child:
            ...
            // _buildEmployeeListTile( context, employee, device);
            // );
            ...
            // final employeeCardContent = new
            Container(
                margin: new EdgeInsets.fromLTRB(horizontal ? 76.0 : 16.0,
                    horizontal ? 16.0 : 42.0, 16.0, 16.0),
