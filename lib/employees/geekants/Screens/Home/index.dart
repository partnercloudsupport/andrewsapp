...
import '../../../widgets/employee_footer.dart';
...
class GeekyAntsHome extends StatefulWidget {
  final Employee employee;
  final Device device;
  const GeekyAntsHome({Key key, this.device, this.employee}) : super(key: key);

  @override
  HomeScreenState createState() => new HomeScreenState();
}

class HomeScreenState extends State<GeekyAntsHome>
            ...
            children: <Widget>[
              new ListView(
                ...
                children: <Widget>[
                  ...
                  //new Calender(),
                  new EmployeeDetailFooter(employee),
                  // new ListViewContent(
