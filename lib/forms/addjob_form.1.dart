...
//   NewJobPage({Key key, this.user,  this.currentList, this.newJob})
//       : super(key: key);
...
// //   final FirebaseUser user;
// //   final JobModel newJob;
// //   const JobDetailPage({Key key, this.newJob, this.user})
// //       : super(key: key);
...
// // class _DetailPageState extends State<JobDetailPage> {
// //   TextEditingController itemController = new TextEditingController();
