...
exports.JoiState = Joi.extend((joi) => ({
    base: joi.string(),
    name: 'state',
    language: {
...
exports.JoiDocument = Joi.extend((joi) => ({
    base: joi.string(),
    name: 'document',
    ...
    rules: [
        {
            ...
            validate(params, value, state, options) {
                ...
                const rcpf = newValue.split("").reverse().join(""); //inverte o cpf
                ...
                if (checkDigit1 === parseInt(rcpf[1]) &&
                    ...
                    return joi.createError('document.invalidCheckDigits', { v: newValue, dv1: checkDigit1, dv2: checkDigit2 }, state, options);
                }
            } //end validate
        } //end rule
    ] //end rules
